...
import storeImg from "../../public/bookstore2.jpg";
                    ...
                    <div className="px-6 mx-auto max-w-7xl lg:px-8">
                        <div className="max-w-2xl mx-auto text-center">
                            ...
                            <p className="mt-6 text-lg leading-8 text-gray-600">
                                Bookbuddy is a small bookstore that specializes
                                in fantasy and mystery books. Find us here in
                                San Diego or order online anytime.
                            </p>
